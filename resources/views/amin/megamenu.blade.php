<div class="megamenu-wrapper">
    <ul class="mw-nav">
        <li><a href="#"><span>Medieval</span></a></li>
        <li><a href="#"><span>Futurista</span></a></li>
        <li><a href="#"><span>Atual</span></a></li>
        <li><a href="#"><span>Outros</span></a></li>
    </ul>
    <div class="mw-post">
        <div class="mw-post-item">
            ...
            <div class="mw-text">
                <h6><a href="#">A Monster Prom poster got hijacked for a Papa Roach concert...</a></h6>
            <ul>
