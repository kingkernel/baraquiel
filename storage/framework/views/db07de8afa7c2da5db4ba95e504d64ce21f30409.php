                        ...
                        <div class="ht-widget">
                            <ul>
                               <!-- <li><i class="fa fa-sun-o"></i> <span>20<sup>c</sup></span> London</li> -->
                                <li><i class="fa fa-clock-o"></i><?php echo date("F"). " de ".date("Y")?> </li>
...
<?php echo $__env->make("amin.megamenu", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </li>
                        <li>
    ...
    <!-- Header End --><?php /**PATH C:\Baraquiel\resources\views/amin/header.blade.php ENDPATH**/ ?>